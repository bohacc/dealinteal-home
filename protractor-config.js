...
exports.config = {
  ...
  seleniumServerJar: 'tools/selenium/selenium-server-standalone-2.44.0.jar',
  //seleniumServerJar: 'tools/selenium/selenium-safari-driver-2.43.1.jar',
  ...
  chromeDriver: 'tools/selenium/chromedriver',

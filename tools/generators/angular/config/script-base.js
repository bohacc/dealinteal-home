...
// 21.5.2014 MB - pridano pro generovani souboru pro preklady
Generator.prototype.translateTemplate = function (src, dest) {
  yeoman.generators.Base.prototype.template.apply(this, [
    src,
    path.join(this.env.options.appPath, dest.toLowerCase()) + '.json'
  ]);
};
